...
import { removeLineBreaks } from "@/lib/tools/remove-line-breaks"
...
export function RemoveLineBreaksTool() {
  ...
  const result = useMemo(() => removeLineBreaks(input), [input])
  ...
  const statItems = [
    ...
    { label: "Line Breaks Removed", value: result.lineBreaksRemoved },
    ...
    <div className="flex flex-col gap-6">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="flex flex-col gap-2">
          <label htmlFor="remove-line-breaks-input" className="text-sm font-medium text-foreground">
            Input
          </label>
          <Textarea
        ...
        <div className="flex flex-col gap-2">
          <label htmlFor="remove-line-breaks-output" className="text-sm font-medium text-foreground">
            Output
          </label>
          <Textarea
            id="remove-line-breaks-output"
            value={result.output}
            readOnly
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <DownloadButton
          value={result.output}
          filename="remove-line-breaks.txt"
